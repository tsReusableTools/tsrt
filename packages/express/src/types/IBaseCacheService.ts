...
export interface IBaseCacheService {
   ...
   */
  set<T = any>(key: string, data: any, time?: number): IMsgPromise<T>;
   ...
   */
  get<T = any>(key: string): IMsgPromise<T>;
   ...
   */
  getAll(ttl?: boolean): IMsgPromise<ICacheRecordsList[]>;

  /** Clears all dbs */
  clearAll(): IMsgPromise;
}
